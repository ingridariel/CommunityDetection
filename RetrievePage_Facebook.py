'''
Code to extract posts from Facebook page in a specific date range

Access Token of your application is required to request data.
To obtain informations of how to access data: https://developers.facebook.com/
