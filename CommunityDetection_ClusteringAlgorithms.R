...
to detect communities of users indicated by clustering validation indexes.
...
intern <- clValid(norm, 2:3, clMethods=c("fanny"), validation="internal", maxitems=600, metric="euclidean", memb.exp=i)
summary(intern)
